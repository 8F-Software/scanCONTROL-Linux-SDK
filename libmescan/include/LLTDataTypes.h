...
// bootstrap registers
#define BOOTSTRAP_REG_IP 0x0000064C
#define BOOTSTRAP_REG_SUBNET 0x0000065C
#define BOOTSTRAP_REG_GATEWAY 0x0000066C
#define BOOTSTRAP_REG_IP_CONFIG 0x00000014
#define IP_CONFIG_PERISTENT 0x00000001
#define IP_CONFIG_DHCP 0x00000002
#define IP_CONFIG_LOCALHOST 0x00000004
...
#define INQUIRY_FUNCTION_IDLE_TIME 0xf0f0050
...
#define ROI2_ENABLE 1
#define RONI_ENABLE (1 << 1)
#define EA_REF_REGION_ENABLE (1 << 2)
#define HIGH_SPEED_MODE_ENABLE (1 << 30)
#define HDR_ENABLE (1 << 31)
#define SENSITIVITY_MINIMUM (0<<3)
#define SENSITIVITY_LOW (1<<3)
#define SENSITIVITY_MEDIUM (2 <<3)
#define SENSITIVITY_HIGH (3<<3)
#define SENSITIVITY_MAXIMUM (4 <<3)

// maintenance flags
#define MAINTENANCE_COMPRESS_DATA 1
#define MAINTENANCE_LOOPBACK (1 << 1)
#define MAINTENANCE_UDPDUMP (1 << 2)
...
#define ERROR_GETSETDEV_GENERAL_ERROR -600
#define ERROR_GETSETDEV_IP_INVALID -601
#define ERROR_GETSETDEV_CREATE_SOCKET_FAILED -602
#define ERROR_GETSETDEV_BIND_DEVICE_FAILED -603
#define ERROR_GETSETDEV_SEND_FAILED -604
#define ERROR_GETSETDEV_ANSWER_INVALID -605

#define ERROR_GETSENSORINFO_GENERAL_ERROR -700
#define ERROR_GETSENSORINFO_CREATE_SOCKET_FAILED -701
...
// sensor info for broadcast search
